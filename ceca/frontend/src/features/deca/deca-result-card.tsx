...
export function DecaResultCard({
  ...
  // El resultado se pinta DEBAJO de un formulario largo: sin esto el usuario
  // solo veia el toast y el QR quedaba fuera de la pantalla. Se lleva la vista
  // y el foco al resultado (MASTER §9: toda accion exitosa confirma).
  useEffect(() => {
  ...
  return (
    <section ref={sectionRef} aria-label={t('deca.generated')} tabIndex={-1} className="outline-none">
      <Card>
        <CardHeader>
